    ...
    <>
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center gap-3 text-stone-700 text-sm">
                ...
                <span>Redeem Points for Coupons</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              ...
              >
                ...
                <div className="text-sm text-stone-500 mt-1">{PLANS.MONTHLY.symbol}{PLANS.MONTHLY.price}/mo</div>
              </button>
              ...
              >
                ...
                <div className="text-sm text-stone-500 mt-1">{PLANS.YEARLY.symbol}{PLANS.YEARLY.price}/yr</div>
                <div className="text-[10px] text-teal-600 font-bold mt-1">Save {PLANS.YEARLY.savings}</div>
              </button>
            </div>

            <button 
              onClick={handleSubscribeClick}
              className="w-full bg-teal-800 text-white py-4 rounded-xl font-medium hover:bg-teal-900 transition-all active:scale-[0.98] shadow-lg flex items-center justify-center gap-2"
            >
              Subscribe Now
            </button>
      ...
      <PaymentGatewayModal 
          ...
          onSuccess={() => {
              ...
              onClose(); // Close the subscription modal too
          }}
      />
    </>
  );
